...
mod tests {
    ...
    fn test_num_passwords() {
        assert_eq!(super::number_of_passwords(278384, 824795, &super::is_valid_password), 921);
        assert_eq!(super::number_of_passwords(278384, 824795, &super::is_valid_password_2), 603);
    }
}